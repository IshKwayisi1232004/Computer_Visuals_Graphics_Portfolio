...
void SceneManager::SetupSceneLights()
{
	...
	m_pShaderManager->setVec3Value("lightSources[0].position", 6.0f, 12.0f, 6.0f);

	// Focus on present a magenta-like color in the scene
	m_pShaderManager->setVec3Value("lightSources[0].ambientColor", 1.08f, 0.01f, 0.05f);
	m_pShaderManager->setVec3Value("lightSources[0].diffuseColor", 0.9f, 0.8f, 0.6f);
	m_pShaderManager->setVec3Value("lightSources[0].specularColor", 1.0f, 0.9f, 0.8f);
	m_pShaderManager->setFloatValue("lightSources[0].focalStrength", 32.0f);
	m_pShaderManager->setFloatValue("lightSources[0].specularIntensity", 0.5f);


	m_pShaderManager->setVec3Value("lightSources[1].position", -2.0f, 2.0f, 4.0f);

	// Softer green tint for visibility
	m_pShaderManager->setVec3Value("lightSources[1].ambientColor", 0.02f, 0.05f, 0.05f);
	m_pShaderManager->setVec3Value("lightSources[1].diffuseColor", 1.0f, 1.0f, 1.0f);
	m_pShaderManager->setVec3Value("lightSources[1].specularColor", 0.3f, 1.0f, 0.3f);
...
void SceneManager::RenderScene()
{
	...
	// set the shader material that will be used in the scene
