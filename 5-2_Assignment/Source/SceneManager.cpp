...
void SceneManager::LoadSceneTextures()
{
	...
	// For the top of the cylinder mesh
	bReturn = CreateGLTexture(
		"../../Utilities/textures/circular-brushed-gold-texture.jpg",
		"cylinder_top");

	// For the side of the cylinder mesh
	bReturn = CreateGLTexture(
...
void SceneManager::RenderScene()
{
	...
	// Use the "floor" tag render the brick texture
	...
	// Code to render the cylinder texture onto the side
	// Boolean values are needed to direct which portions of the mesh
	// recieve the textures, specifically the third parameter
	SetShaderColor(1, 1, 1, 1);
	...
	// Code to render the cylinder_top texture onto the top and bottom
	// Boolean values are needed to direct which portions of the mesh
	// recieve the textures, specifically the first and second parameters
	SetShaderColor(1, 1, 1, 1);
	...
	// Use the "plank" tag to render the wood texture
	SetShaderColor(1, 1, 1, 1);
	...
	// Use the "box" tag to render the tilesf2 texture
	SetShaderColor(1, 1, 1, 1);
	...
	// Use the "ball" tag to render the stained glass texture
	SetShaderColor(1, 1, 1, 1);
	...
	// Use the "cone" tag render the abstract texture
	SetShaderColor(1, 1, 1, 1);
