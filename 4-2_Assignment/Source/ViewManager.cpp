...
GLFWwindow* ViewManager::CreateDisplayWindow(const char* windowTitle)
{
	...
	// this callback is used to enable and recieve mouse wheel scrolling events
...
void ViewManager::Mouse_Position_Callback(GLFWwindow* window, double xMousePos, double yMousePos)
{
	...
	float yOffset = (gLastY - yMousePos) * rotationSensitivity; // reversed since y-coordinates go from bottom to top
